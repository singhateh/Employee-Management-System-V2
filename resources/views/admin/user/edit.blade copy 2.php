  ...
  <div class="row">
   ...
   <div class="col-md-6 col-sm-12 col-xs-12">
     <div class="x_panel">
       ...
       {{-- <form action="{{route('user.update',$users_id->user_id)}}"  class="form-horizontal" enctype="multipart/form-data" class="form-horizontal form-label-left"> --}}
     ...
     {{-- </div>
        ...
        <div class="x_title"> --}}
          <h2><b>Update </b> Employee Informtion <small> Portal</small></h2>
          <ul class="nav navbar-right panel_toolbox">
          ...
          <br />
            ...
            <div class="form-group">
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <input type="text" id="img" name="img" value="{{$user->image}}" class="form-control col-md-7 col-xs-12" placeholder="Enter First Name">
              </div>
              <div class="col-md-6 col-sm-6 col-xs-12">
          ...
          <div class="x_content">
            ...
            <div class="form-horizontal form-label-left">
              <div class="form-group" style="display:none">
                ...
                <div class="col-md-2 col-sm-6 col-xs-12">
                <input type="hidden" id="single_cal4" name="jdate"  class="form-control col-md-7 col-xs-12" placeholder="join Date" value="{{ $user->roll_no }}" disabled>
                </div>
              </div>
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12">
