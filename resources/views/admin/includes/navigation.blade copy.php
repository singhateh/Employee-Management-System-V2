        ...
        <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="{{route('dashboard')}}">
                <b class="logo-icon p-l-10">
                    <img src="{{asset('image/logo1.png')}}" width="200" height="50" alt="homepage" class="light-logo" />
                </b>
                <span class="logo-text">
                             <!-- dark Logo text -->
                             {{-- <img src="{{asset('image/employee-management-system.png')}}" width="70" height="30" alt="homepage" class="light-logo" /> --}}
