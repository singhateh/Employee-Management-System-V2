...
<body>
 <div style="height: 45px;background-image:url('{{ asset('/image/employees_image.png') }}');border-radius: 5px;position:relative">
        ...
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                <div class="text-center p-t-20 p-b-20">
                    <span class="db"><img src="{{asset('image/logo1.png')}}" width="200" height="90"  alt="logo" /></span>
                </div>
                <!-- Form -->
